package zx.soft.es.sqloperation;
...
import zx.soft.es.utils.MybatisConfig;
...
public class SQLOperation {
	 ...
	 * @return
	 */
	public List<SinaWeibo> getWeiboData(String tablename, int from) {

		try (SqlSession sqlSession = sqlSessionFactory.openSession();) {
			WeiboMapper weiboMapper = sqlSession.getMapper(WeiboMapper.class);
			List<SinaWeibo> weibos = weiboMapper.getWeiboData(tablename, from);
			logger.info(weibos.toString());
	...
	public static void main(String[] args) {
		...
		/*sqlOperation.getWeiboData("sina_user_weibos_1386614765", 30);
