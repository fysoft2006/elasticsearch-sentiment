...
public class Weibo {
	...
	public String toString() {
		return "Weibo [id=" + id + ", platform=" + platform + ", mid=" + mid + ", username=" + username + ", nickname="
				+ nickname + ", original_id=" + original_id + ", original_uid=" + original_uid + ", original_name="
				+ original_name + ", original_title=" + original_title + ", original_url=" + original_url + ", url="
				+ url + ", home_url=" + home_url + ", title=" + title + ", type=" + type + ", isharmful=" + isharmful
				...
				+ server_id + ", identify_id=" + identify_id + ", identify_md5=" + identify_md5 + ", keyword="
				+ keyword + ", first_time=" + first_time + ", update_time=" + update_time + ", ip=" + ip
				+ ", location=" + location + ", geo=" + geo + ", receive_addr=" + receive_addr + ", append_addr="
				+ append_addr + ", send_addr=" + send_addr + ", source_name=" + source_name + ", source_type="
				+ source_type + ", country_code=" + country_code + ", location_code=" + location_code
				+ ", province_code=" + province_code + ", city_code=" + city_code + "]";
	}
}
